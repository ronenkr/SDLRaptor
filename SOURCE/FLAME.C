...
)
{
   ...
   {
      /* port: the 256-alignment hack (a truncating pointer->INT cast on
         x64) served the ASM shade routines' indexing trick; the C
         blitters index normally, so the raw table is fine */
