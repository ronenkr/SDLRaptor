...
)
{
   ...
   /* port: FRAME_COUNT is clock-derived and read-only; the old reset to 0
      was redundant (local_cnt is re-latched before each use) */
...
)
{
   ...
   /* port: FRAME_COUNT is clock-derived and read-only (see above) */
